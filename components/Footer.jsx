...
const Footer = () => {
  return (
    <>
      <div className="mx-auto sticky top-[100vh] container xl:px-20 lg:px-12 sm:px-6  px-4 py-12">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex items-center mt-6">
            <p className=" leading-4 text-gray-800  text-xs ">
              2021 <span className="font-semibold ">@dibery.co</span>
            </p>
            <div className="border-l border-gray-800 pl-2 ml-2 ">
              <p className=" leading-4 text-gray-800 font-extralight  text-xs">
                Build With 🖤
              </p>
            </div>
          </div>
